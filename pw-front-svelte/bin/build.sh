...
SERVER_URL=$(prompt_user "Enter SERVER_URL (Where pw-back is exposed)" "$(hostname -I):3030/")
echo "Same as Server URL, but using Port 3080"
PALDEX_API_URL=$(prompt_user "Enter PALDEX_API_URL" "$(hostname -I):3080/")
echo ""
